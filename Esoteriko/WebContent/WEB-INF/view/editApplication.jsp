...
<h2>Σύστημα Διαχείρισης Αιτήσεων Σίτισης - Επεξεργασία Αίτησης</h2>

<div id="container">
	
	<form:form action="saveEditProfile" modelAttribute="application" method="POST" >
		...
		<table>
			<tbody>
				...
				<tr>
					<td><label>Εγκρίθηκε(*):</label></td>
					<td>
						Yes<form:radiobutton path="validated" value="Yes"/>
						No<form:radiobutton path="validated" value="No"/>
					</td>
				</tr>
